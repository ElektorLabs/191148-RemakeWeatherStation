...
//
//  This is the Pinmapping for M5Stack Basic
//
//  IO22 : SCL
//  IO21 : SDA
//  IO19 : MISO ( SD-CARD / LCD )
//  IO23 : MOSI ( SD-CARD / LCD )
//  IO18 : SCKL ( SD-CARD / LCD )
//  IO04 : CS0  ( SD-CARD )
//  IO14 : CS1  ( LCD )
//  IO27 : DC ( LCD )
//  IO33 : RST ( LCD )
...
//  IO36 : WIND DIR
//  
//  IO03 : TX1 ( Particle Sensor )
//  IO01 : RX1 ( Particle Sensor )
//
//
//
//
...
/* We define the pins used for the various components */
  ...
  #define INPUT_RAIN           ( 36 )
  #define INPUT_WINDSPEED      ( 35 )
  #define INPUT_WINDDIR        ( 34 )

  #define I2C0_SCL             ( 22 )
  #define I2C0_SDA             ( 21 )

  #define PARTICLESENSOR_RX    ( 16 )
  #define PARTICLESENSOR_TX    ( 17 )
